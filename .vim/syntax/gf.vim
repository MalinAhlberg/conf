...
syn match gfAModule		"abstract"
syn match gfModule		"\<concrete\>"
syn match hsModule		"\<module\>"
syn region gfModule		start="abstract\|concrete" end="{" contains=hsCharacter
syn match gfImportMod		contained "\<\(in\|qualified\|hiding\)\>"
...
syn match gfStructure		"\<\(of\|class\|data\|deriving\|instance\|default\|where\)\>"
syn match hsTypedef		"\<\(\)\>"
syn match hsStatement		"\<\(do\|case\|of\|lin\|let\|in\|cat\|fun\|lin\|lincat\|oper\|param\)\>"
...
if version >= 508 || !exists("did_hs_syntax_inits")
  ...
  HiLink gfCModule			  gfStructure
  HiLink gfAModule			  gfStructure
  HiLink hsModule			  gfStructure
  HiLink gfImport			  Include
  HiLink gfImportMod			  gfImport
  HiLink hsImport			  Include
  HiLink hsImportMod			  hsImport
  HiLink hsInfix			  PreProc
  HiLink gfStructure			  Structure
  ...
  HiLink gfPathPragma			  SpecialComment
